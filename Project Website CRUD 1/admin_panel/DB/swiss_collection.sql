...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2024 at 04:59 AM
...
(1, 'Anggur', 'Rasa anggur sangat bervariasi, tergantung pada varietas, kematangan, dan cara pengolahannya. Secara umum, anggur memiliki rasa yang manis, asam, dan sedikit pahit. Rasa manisnya berasal dari gula alami yang terkandung dalam\r\n              buah anggur. Rasa asamnya berasal dari asam tartarat dan asam sitrat. Rasa pahitnya berasal dari senyawa tannin. Manfaat anggur juga sangat beragam. Anggur merupakan sumber vitamin, mineral, dan antioksidan yang baik', './img/menu/8.jpg', 35000, 1, '2022-03-28'),
(2, 'Telur', 'Telur berkualitas tinggi, mengandung protein tinggi', '', 890, 4, '2022-04-04'),
(3, 'Jagung', 'Salah satu sumber karbohidrat selain beras/nasi, jagung juga memiliki serat yang tinggi dan baik untuk tubuh', '', 600, 1, '2022-04-04'),
(4, 'Salad', 'Hidangan yang dibuat dari berbagai macam sayuran/buah yang mengandung protein dan serat', '', 29000, 2, '2022-04-04'),
(5, 'Daging Sapi', 'Daging sapi salah satu daging yang paling sering dikonsumsi, mengandung protein, serta zat besi', '', 179000, 4, '2022-04-04');
